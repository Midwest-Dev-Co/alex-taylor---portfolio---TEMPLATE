          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-slate-600">
                With a keen eye for detail and a passion for storytelling, I
                bring every performance to life with authenticity and emotion.
                Whether on stage or behind the scenes, I strive to transform
                creative visions into unforgettable experiences.
              </p>
